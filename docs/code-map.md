...
| [campaign-start-rules](../fixtures/manifests/campaign-start-rules.json) | cpp-reference | `mods/campaign-start-rules.expected.json` | `CampaignStartRulesFixtureTests` ([CampaignStartRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/CampaignStartRulesFixtureTests.cs))<br>`Phase3ContentCorpusTests` ([Phase3ContentCorpusTests.cs](../tests/Oxce.CompatibilityTests/Phase3ContentCorpusTests.cs)) |
...
| [equipment-production-rules](../fixtures/manifests/equipment-production-rules.json) | cpp-reference | `mods/equipment-production-rules.expected.json` | `EquipmentProductionRulesFixtureTests` ([EquipmentProductionRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/EquipmentProductionRulesFixtureTests.cs)) |
...
| [item-rules](../fixtures/manifests/item-rules.json) | cpp-reference | `mods/item-rules.expected.json` | `ItemRulesFixtureTests` ([ItemRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/ItemRulesFixtureTests.cs)) |
...
| [mission-event-rules](../fixtures/manifests/mission-event-rules.json) | cpp-reference | `mods/mission-event-rules.expected.json` | `MissionEventRulesFixtureTests` ([MissionEventRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/MissionEventRulesFixtureTests.cs)) |
...
| [personnel-tactical-rules](../fixtures/manifests/personnel-tactical-rules.json) | cpp-reference | `mods/personnel-tactical-rules.expected.json` | `PersonnelTacticalRulesFixtureTests` ([PersonnelTacticalRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/PersonnelTacticalRulesFixtureTests.cs)) |
| [presentation-rules](../fixtures/manifests/presentation-rules.json) | cpp-reference | `mods/presentation-rules.expected.json` | `PresentationRulesFixtureTests` ([PresentationRulesFixtureTests.cs](../tests/Oxce.CompatibilityTests/PresentationRulesFixtureTests.cs)) |
...
| [strategic-logistics](../fixtures/manifests/strategic-logistics.json) | cpp-reference | `savegames/strategic-logistics.expected.json` | `StrategicLogisticsFixtureTests` ([StrategicLogisticsFixtureTests.cs](../tests/Oxce.CompatibilityTests/StrategicLogisticsFixtureTests.cs))<br>`InstallationContentLoaderTests` ([InstallationContentLoaderTests.cs](../tests/Oxce.UnitTests/Mods/InstallationContentLoaderTests.cs))<br>`TestFixtures (helper)` ([TestFixtures.cs](../tests/Shared/TestFixtures.cs)) |
...
| `mods/strategic-logistics` | `StrategicLogisticsFixtureTests` ([StrategicLogisticsFixtureTests.cs](../tests/Oxce.CompatibilityTests/StrategicLogisticsFixtureTests.cs))<br>`StrategicReadinessTestContent (helper)` ([StrategicReadinessTestContent.cs](../tests/Oxce.CompatibilityTests/StrategicReadinessTestContent.cs))<br>`InstallationContentLoaderTests` ([InstallationContentLoaderTests.cs](../tests/Oxce.UnitTests/Mods/InstallationContentLoaderTests.cs))<br>`TestFixtures (helper)` ([TestFixtures.cs](../tests/Shared/TestFixtures.cs)) |
