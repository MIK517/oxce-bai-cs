...
$template = $template.Replace('// TRANSFER_DISTANCE', (Read-ReferenceMethod 'src\Basescape\TransferItemsState.cpp' 'double TransferItemsState::getDistance('))
$work = Join-Path $repository 'artifacts\reference-strategic-logistics'
[IO.Directory]::CreateDirectory($work) | Out-Null
$probe = Join-Path $work 'strategic_logistics_probe.cpp'
$exe = Join-Path $work 'strategic_logistics_probe.exe'
...
$output = Join-Path $work 'strategic-logistics.actual.json'
